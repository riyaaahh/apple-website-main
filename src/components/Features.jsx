        ...
        <div className="h-full common-padding bg-zinc relative overflow-hidden">
          ...
          <div className="flex-center flex-col sm:px-10">
            ...
            <div className="flex w-full relative ">
              <div className="flex-1 h-[40vh] overflow-hidden">
                <img src={explore1Img} alt='titanium' className="feature-video g_grow w-full h-full object-cover"/>
              </div>
              <div className="flex-1 h-[40vh] overflow-hidden ml-4">
                <img src={explore2Img} alt='titanium2' className="feature-video g_grow w-full h-full object-cover"/>
              </div>
            </div>
